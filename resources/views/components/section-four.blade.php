<div class="row mt-4">
    ...
    <hr />
    <div class="col-md-6">
        <a href="<?php echo url('/read/' . $section_four_first_news->id); ?>" class="d-block">
            <img src="{{ asset('storage/media/news/' . $section_four_first_news->image) }}" alt="news-image"
                class="img-fluid rounded" loading="lazy" />
        </a>
        <a href="<?php echo url('/read/' . $section_four_first_news->id); ?>" class="text-decoration-none text-dark my-2 d-block">
            <p class="h5">
        ...
        <p class="mt-1">
            ...
            <a href="<?php echo url('/read/' . $section_four_first_news->id); ?>" class="text-decoration-none text-primary">...Read More</a>
        </p>
    </div>
    <div class="col-md-6">
        <div class="row">
