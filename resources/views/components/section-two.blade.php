    ...
    <div class="row">
        @foreach ($section_two_news as $news)
            <div class="col-md-4 mb-2">
                ...
                <div>
                    <a href="<?php echo url('/read/' . $news->id); ?>" class="d-block text-dark text-decoration-none mt-1">
                ...
                <div>
                    <p>
                        ...
                        <a href="<?php echo url('/read/' . $news->id); ?>" class="text-primary text-decoration-none">...Read more</a>
                    </p>
                </div>
            </div>
        @endforeach
