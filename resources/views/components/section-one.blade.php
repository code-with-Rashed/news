<section>
    <div class="container mt-5">
        <div class="row">
            ...
            <hr />
            <div class="col-md-4">
                <a href="<?php echo url('/read/' . $first_news->id); ?>" class="d-block">
                    <img src="{{ asset('storage/media/news/' . $first_news->image) }}" alt="news-image"
                        class="rounded img-fluid" loading="lazy" />
                </a>
                <a href="<?php echo url('/read/' . $first_news->id); ?>" class="text-decoration-none d-block text-dark">
                    <p class="h5 mt-2">
                        {{ $first_news->title }}
                    </p>
                </a>
                ...
                <p>
                    ...
                    <a href="<?php echo url('/read/' . $first_news->id); ?>" class="text-primary text-decoration-none">...Read more</a>
                </p>
            </div>
            <div class="col-md-8">
                <div class="row">
                    @foreach ($section_one_news as $news)
                        <div class="col-md-4 mb-3">
                            ...
                            <a href="<?php echo url('/read/' . $news->id); ?>" class="text-decoration-none text-dark mt-1 d-block">
                                <p>{{ $news->title }}</p>
                            </a>
